...
const fotos = [
  ...
  { src: '/la-casa-hero.jpg', alt: 'La casa' },
    ...
    <main>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
            {fotos.map((foto, i) => (
              <button
                ...
                className="group aspect-square overflow-hidden bg-stone-200 focus:outline-none"
              >
                <div
      ...
      {selected !== null && (
        ...
        >
          {/* Imagen */}
          <div
            className="relative max-w-5xl w-full max-h-[85vh] bg-cover bg-center bg-no-repeat"
            style={{
              backgroundImage: `url('${fotos[selected].src}')`,
              aspectRatio: '4/3',
            }}
          ...
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 bg-black/40 hover:bg-black/70 text-white w-12 h-12 flex items-center justify-center rounded-full text-2xl transition-colors"
            aria-label="Anterior"
          >
            ‹
          </button>
          ...
          <button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 bg-black/40 hover:bg-black/70 text-white w-12 h-12 flex items-center justify-center rounded-full text-2xl transition-colors"
