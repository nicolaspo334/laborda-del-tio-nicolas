...
function Carousel({ images, onZoom }) {
  ...
  return (
    <div
      className="relative overflow-hidden rounded-sm aspect-[4/3] bg-stone-200 shadow-md cursor-zoom-in"
...
function ClickableImage({ src, onZoom }) {
  return (
    <div
      className="w-full aspect-[4/3] bg-stone-300 bg-cover bg-center rounded-sm shadow-md cursor-zoom-in"
    ...
    <main>
      ...
      <section className="py-20 bg-stone-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-14 items-center">
            ...
            <Carousel
              images={['salon-inferior.jpg','salon-inferior-2.jpg','salon-inferior-3.jpg','salon-inferior-4.jpg','salon-inferior-5.jpg','salon-inferior-6.jpg','salon-inferior-7.jpg','salon-inferior-8.jpg','salon-inferior-9.jpg','salon-inferior2.jpg'].map(f => `/${f}`)}
              onZoom={setLightbox}
            />
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-14 items-center">
            <Carousel
              images={['/salon-superior.jpg','/salon-superior-2.jpg','/salon-superior-3.jpg','/salon-superior-4.jpg']}
              onZoom={setLightbox}
            />
            <div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-14 items-start">
            ...
            <div className="sticky top-28">
              <Carousel
                images={['/habitacion-rio.jpg','/habitacion-rio-2.jpg','/habitacion-balcon.jpg','/habitacion-balcon-2.jpg','/habitacion-ventana.jpg','/habitacion-ventana-2.jpg','/habitacion-ventana-3.jpg']}
                onZoom={setLightbox}
              />
            </div>
          </div>
      ...
      <section className="py-20 bg-stone-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-14 items-start">
            <div className="sticky top-28">
              <Carousel
                images={['/bano-1.jpg','/bano-1-2.jpg','/bano-1-3.jpg','/bano-2.jpg','/bano-2-2.jpg','/bano-2-3.jpg','/bano-3.jpg']}
                onZoom={setLightbox}
              />
            </div>
            <div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-14 items-center">
            ...
            <Carousel
              images={['/terraza.jpg', '/terraza-2.jpg', '/terraza-3.jpg', '/terraza-4.jpg']}
              onZoom={setLightbox}
            />
          </div>
        </div>
